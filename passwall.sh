...
rm -f passwalls.sh && wget https://raw.githubusercontent.com/TxENGAx/Passwall2-Openwrt-25/main/passwalls.sh && chmod 777 passwalls.sh && sh passwalls.sh
...
for feed in passwall_luci passwall_packages passwall2; do
  echo "src/gz $feed https://master.dl.sourceforge.net/project/openwrt-passwall-build/releases/packages-$release/$arch/$feed" >> /etc/apk/customfeeds.conf
done
